...
export default class Canvas extends Component{
    constructor(owner, cfg) {
        ...
        this._m_ClearColor = new Vector4(0.3, 0.3, 0.3, 1.0);
        if(this._m_Canvas){
    ...
    _init(){
        let gl = this._m_GL;
        gl.clearColor(this._m_ClearColor._m_X, this._m_ClearColor._m_Y, this._m_ClearColor._m_Z, this._m_ClearColor._m_Z);
    ...
    setClearColor(r, g, b, a){
        ...
        this._m_ClearColor.setToInXYZW(r, g, b, a);
    }
